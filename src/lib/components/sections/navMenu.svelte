			...
			<div class="breakout grid gap-12 md:grid-cols-[1.3fr_1fr] mt-auto">
				...
				>
					<div class="space-y-3 text-sm text-primary-foreground/70">
						...
						<a href="tel:+256752606904" class="flex items-center gap-3 hover:text-accent transition-colors">
							<Phone class="size-4" /> +256 752 606 904
						</a>
						<a href="mailto:hello@fiatcreativeevents.com" class="flex items-center gap-3 hover:text-accent transition-colors">
							<Mail class="size-4" /> hello@fiatcreativeevents.com
						</a>
					</div>
